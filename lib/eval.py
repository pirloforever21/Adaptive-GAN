...
def get_fid_score(imgs, batch_size=50, dims=2048, cuda=False, verbose=False):
    ...
    stats_path = 'lib/data/fid_stats_cifar10_train.npz'
...
def get_inception_score(imgs, batch_size=50, dims=2048, cuda=False, verbose=False, splits=10):
    ...
    preds = _get_preds(imgs, model, batch_size, dims, cuda, verbose)
